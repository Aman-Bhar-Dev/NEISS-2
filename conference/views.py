    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for i in range(20):
                ...
                accommodation = request.POST.get(f'coauthor_accommodation_{i}', 'NOT-REQUIRED')
                food = request.POST.get(f'coauthor_food_{i}', 'VEG')
            ...
            # Confirmation email
            send_mail(
                subject="NEISS 2025 - Abstract Submission Confirmation",
                message=f"""Dear {request.user.first_name},

Thank you for submitting your abstract to NEISS 2025. Our team will review your submission and notify you of the next steps.
